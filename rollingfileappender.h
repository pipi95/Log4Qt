...
public:
    ...
    QString maxFileSize() const; // add by pzc 2017.12.18  changed by pzc 2018.6.8
...
inline QString RollingFileAppender::maxFileSize() const // add by pzc 2017.12.18
{
    qint64 size = maximumFileSize();
